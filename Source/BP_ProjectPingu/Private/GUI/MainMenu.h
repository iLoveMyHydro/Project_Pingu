...
private:
	...
	const FName LEVEL_NAME = FName(TEXT("/Script/Engine.World'/Game/IcePropsContent/Maps/Demo_Map.Demo_Map'"));
	const FName OPTION_LEVEL_NAME = FName(TEXT("/Script/Engine.World'/Game/Maps/OptionMenu_Code.OptionMenu_Code'"));
